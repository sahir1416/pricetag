...
export async function scrapeAmazonProduct(url: string) {   
    if(!url) return;
    // curl --proxy brd.superproxy.io:22225 --proxy-user brd-customer-hl_cb4d8de8-zone-pricetag:zcdyeoyd1lt2 -k "http://geo.brdtest.com/mygeo.json"
   ...
   try {
      ...
      //console.log({title, currentPrice, orignalPrice, outOfStock, imageUrls, currency, discountRate, data,description})
      return data;
   } catch (error: any) {
